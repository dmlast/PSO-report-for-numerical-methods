...
Готовый PDF создается как `tex/slides.pdf`. Он не хранится в репозитории, потому что PDF со встроенными анимациями получается больше лимита GitHub на обычные файлы.
